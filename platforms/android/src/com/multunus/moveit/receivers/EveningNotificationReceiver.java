...
public class EveningNotificationReceiver extends MoveItReceiver  implements NotificationFetcher.NotificationFetchListener{
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(eligibleToNotify(LATE_HOUR)){
            ...
            notificationFetcher.execute(Configuration.NOTIFICATION_URL, email, String.valueOf(Configuration.EveningNotification.HOUR));
        }
    }
